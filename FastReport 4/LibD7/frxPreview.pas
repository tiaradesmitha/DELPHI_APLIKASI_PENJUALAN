...
begin
  ...
  begin
    ...
    begin
      FWorkspace.AddPage(PageSize.X, PageSize.Y);
      FThumbnail.AddPage(PageSize.X, PageSize.Y);
      FWorkspace.CalcPageBounds(FWorkspace.ClientWidth);
      FThumbnail.CalcPageBounds(FThumbnail.ClientWidth);
    end;
  end;
...
function TfrxPreview.HasOutline: Boolean;
begin
  Result := TfrxOutline(PreviewPages.Outline).Root.Count > 0;
end;
